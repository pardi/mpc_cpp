...
class LinearSys{
    ...
    public: 
        LinearSys(const std::array<double, 16>& A, const std::array<double, 4>& b, const std::array<double, 4>& c, const std::array<double, 4>& x0, double dt): A_{A}, b_{b}, c_{c}, x0_{x0}, dt_{dt}, x_{x0}{}
        ~LinearSys() = default;
